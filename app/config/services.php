...
// uncomment the following line for MySQL
 $mysqldsn = 'mysql:host=' . $config['database']['host'] . ';dbname=' . $config['database']['dbname'] . ';charset=utf8mb4';
...
// In development, you'll want the class that captures the queries for you. In production, not so much.
 ...
 $app->register('mysql', $pdoClass, [ $mysqldsn, $config['database']['user'] ?? null, $config['database']['password'] ?? null ]);
